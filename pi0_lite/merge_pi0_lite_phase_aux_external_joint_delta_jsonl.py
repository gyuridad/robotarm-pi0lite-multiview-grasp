...
def merge_pi0_lite_phase_aux_external_joint_delta_jsonl(
    root_dir: str,
    output_jsonl: str = "merged_samples_pi0_aux_external_joint_delta.jsonl",
    input_jsonl_name: str = "samples_pi0_aux_external_joint_delta.jsonl",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Merge pi0_lite_phase_aux_external joint-delta jsonl files from multiple episode directories."
    )
    parser.add_argument("--root_dir", type=str, required=True)
    parser.add_argument("--output_jsonl", type=str, default="merged_samples_pi0_aux_external_joint_delta.jsonl")
    parser.add_argument("--input_jsonl_name", type=str, default="samples_pi0_aux_external_joint_delta.jsonl")
...
def main() -> None:
    ...
    merge_pi0_lite_phase_aux_external_joint_delta_jsonl(
...
## 사용 예시
# python3 /home/lst7910/isaac_ros2_ws/IsaacSim-ros_workspaces/humble_ws/src/robotarm_project/pi0_lite/merge_pi0_lite_phase_aux_external_joint_delta_jsonl.py \
...
#   --output_jsonl merged_samples_pi0_aux_external_joint_delta.jsonl \
#   --input_jsonl_name samples_pi0_aux_external_joint_delta.jsonl \
