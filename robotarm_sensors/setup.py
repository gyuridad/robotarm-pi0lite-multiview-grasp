...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'udp_camera_sender_debug_multi = robotarm_sensors.udp_camera_sender_debug_multi:main',
            'udp_external_rgb_sender_debug = robotarm_sensors.udp_external_rgb_sender_debug:main',
            'udp_hand_camera_sender_debug = robotarm_sensors.udp_hand_camera_sender_debug:main',
